...
//
// fingerprint 会被 sync_objects.agentred_fingerprint 与 agent_session_saves
// .device_fingerprint 拿去比较，那两列必须用同一个排序规则。
//
...
// 为此再加一个生成列。
func baselineDevices() *gormigrate.Migration {
