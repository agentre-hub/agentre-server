...
// migration202605200004 创建 device_tokens 表。
//
// refresh_token_hash 是 sha256 的十六进制（device_svc 里 hex.EncodeToString，恒为
// 64 位小写），access_jti 是 ULID，ip 是点分/冒号文本：三者都是机器生成的标识，
// 用 utf8mb4_bin 逐字节判等。尤其 refresh_token_hash 上挂着唯一键，
// 大小写不敏感会让两个不同的哈希互相顶掉。user_agent 是外部原文，留默认排序规则。
//
		...
		Migrate: func(tx *gorm.DB) error {
			return tx.Exec(`
				CREATE TABLE device_tokens (
				  ...
				  access_jti          varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
				  refresh_token_hash  varchar(64) COLLATE utf8mb4_bin NOT NULL,
				  refresh_expires_at  bigint NOT NULL DEFAULT 0,
				  last_used_at        bigint NOT NULL DEFAULT 0,
				  rotated_from_id     bigint NOT NULL DEFAULT 0,
				  revoked_at          bigint NOT NULL DEFAULT 0,
				  user_agent          varchar(512) NOT NULL DEFAULT '',
				  ip                  varchar(45) COLLATE utf8mb4_bin,
