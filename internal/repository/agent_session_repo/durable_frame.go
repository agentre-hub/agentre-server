...
// DeleteFrames 按 dbutil.CleanupBatchSize 批删除，WHERE 带齐身份键两列：少了 user_id 是
// 跨账号删。循环直到某一批没删满——没删满就说明够到底了；删满一批说明后面大概率还有，
...
func (r *durableFrameRepo) DeleteFrames(
	...
	_, err := dbutil.DeleteBatched(ctx, &agent_session_entity.DurableFrame{},
