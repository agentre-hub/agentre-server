...
type Settings struct {
	...
	// 明写了这一条）。
	ActivityStatsEnabled bool `gorm:"column:activity_stats_enabled;default:false"`
	// ActivityStatsEnabledAt 是最近一次开启的时刻（Unix 毫秒），0 = 从未开启。
	ActivityStatsEnabledAt int64 `gorm:"column:activity_stats_enabled_at;default:0"`
	...
	ActivityLastPullAt int64 `gorm:"column:activity_last_pull_at;default:0"`
	...
	// 依然在。
	ActivityBackfillFrom string `gorm:"column:activity_backfill_from;default:''"`
