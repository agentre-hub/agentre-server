// Package exec_order_entity 维护浏览器的执行目标排列偏好。
//
...
// DeviceExecTargetOrder 是 browser_exec_target_orders 的一行。浏览器 client ID
// 只是账号内偏好的命名空间，不是可鉴权、可寻址的设备身份。
...
func (*DeviceExecTargetOrder) TableName() string { return "browser_exec_target_orders" }
