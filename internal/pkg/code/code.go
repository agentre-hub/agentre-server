...
const (
	DeviceFlowAuthorizationPending = 30200
	DeviceFlowSlowDown             = 30201
...
// Relay 30400~30499
const (
	RelayDaemonNotFound = 30400
	RelayDaemonOffline  = 30401
	RelayForwardFailed  = 30402
)
...
const (
	...
	AccountChannelUnavailable = 30700
)
...
const (
	...
	// 直接打端点的请求。
	OrgProjectPathDesktopReadOnly = 30807
)
...
const (
	...
	SessionImportMachineOffline = 31000
