...
and you get no spans and no metrics, with no error. `task.RelayDrain` is the deliberate
exception: it has no HTTP middleware and must follow `mux.HTTP` for its shutdown ordering.
